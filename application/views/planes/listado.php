          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <tbody>
                  <?php foreach($planes as $plan): if ($plan->estado == "1") { $estado = 'Eliminar'; } else { $estado = 'Restaurar'; }  ?>
                  <tr>
                    <td>
                      <img alt="logo" src="<?php echo base_url('app/files/aseguradoras/'.$plan->img);?>" style="width: 80px; height: 80px;">
                    </td>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="<?php echo base_url('planes/eliminar/'.$plan->id_plan);?>" class="btn btn-block btn-danger"><?php echo $estado;?></a>
                      </div>
                      <div class="btn-group">
                        <a href="<?php echo base_url('planes/editar/'.$plan->id_plan);?>" class="btn btn-block btn-secondary">Editar</a>
                      </div>

                     <!--  <div class="btn-group">
                        <a href="<?php //echo base_url('planes/editar/'.$plan->id_plan);?>" class="btn btn-block btn-secondary">Imprimir</a>
                      </div> -->
                    </td>
                  </tr>
                  <?php endforeach;?>
      ...
      "language": {
                    "lengthMenu": '<div class="col">'+
                      '<div class="form-group">'+
                        '<a href="<?php echo base_url('planes/nuevo');?>" class="btn btn-primary">Nuevo plan</a> <select class="form-control">'+
