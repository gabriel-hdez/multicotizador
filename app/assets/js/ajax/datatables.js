 ...
 *   https://datatables.net/download/#dt/dt-1.10.18/b-1.5.2/b-flash-1.5.2/cr-1.5.0
 *
 * Included libraries:
 *   DataTables 1.10.18, Buttons 1.5.2, Flash export 1.5.2, ColReorder 1.5.0
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		// var input = '<div class="input-field col s6" style="position:absolute; right:0;">'
  ...
  //       	+'</div>';
		...
		var input = '<div class="nav-wrapper white z-depth-2 col s6 push-s6">'
					+'<div class="input-field">'
					+'<input id="search" type="search" name="search" placeholder="Buscar...">'
					+'<label class="label-icon" for="search"><i class="material-icons" style="position: relative; top:-.2rem;">search</i></label>'
					+'</div> </div>';
		...
		var filter = $('<div/>', {
			...
			//.append( $('<div class="row" style="position:relative;"/>' ).append( str ) );
			.append( $('<div class="row" style="position:relative;">' ).append( str ) );
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var div = $('<div><div style="position:relative; z-index:2;"/></div>').addClass( classes.sLength );
	...
	function _fnFeatureHtmlPaginate ( settings )
	{
		var
			...
			node = $('<ul class="pagination center"/>').addClass( settings.oClasses.sPaging + type )[0],
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.18/b-1.5.2/b-flash-1.5.2/cr-1.5.0",
	...
	$.extend( DataTable.ext.classes, {
		...
		/* Paging buttons */
		"sPageButton": "paginate_button waves-effect btn-flat",
